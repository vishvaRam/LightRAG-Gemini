...
async def llm_model_func(
    ...
    return await gemini_model_complete(
        ...
        model_name="gemini-2.0-flash-exp",  # Changed from model_name to model
        **kwargs
    )  # type: ignore 
...
async def initialize_rag():
    ...
    rag = LightRAG(
        ...
        embedding_func_max_async=4,  # Reduced from default 16
        embedding_batch_num=8,  # Reduced from default 32
